...
x=jane.split ('START OF THIS PROJECT GUTENBERG EBOOK PRIDE AND PREJUDICE')
print(x)
jane_cleaned=(x[1])
y=jane_cleaned.replace('man', 'person')
jane_cleaned_final=y.replace('wife', 'partner')
print(jane_cleaned_final)

# bonus=jane_cleaned_final.replace(input (), input ())
# print (bonus)
